module ApiUmbrellaTestHelpers
  module FormattedErrors
    ...
    def assert_json_error(response, error_code = "API_KEY_OR_TOKEN_MISSING")
    ...
    def assert_xml_error(response, content_type = "application/xml", error_code = "API_KEY_OR_TOKEN_MISSING")
      assert_response_code(403, response)
    ...
    def assert_csv_error(response, error_code = "API_KEY_OR_TOKEN_MISSING")
      assert_response_code(403, response)
    ...
    def assert_html_error(response, error_code = "API_KEY_OR_TOKEN_MISSING")
      assert_response_code(403, response)
